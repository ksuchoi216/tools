...
class Generator:
    def __init__(
        ...
        *,
        ...
        self.node_name = node_name or self.prompt_key or "prompt_generator"
    ...
    def verify_input(self, input_data: dict[str, Any]) -> bool:
        ...
        if missing_keys:
            logger.warning(
                "Input data is missing keys required by PromptGenerator {}: {}",
                self.node_name,
                missing_keys,
            )
            return False
    ...
    def invoke(
        ...
        *,
        ...
        logger.info("Invoking PromptGenerator.")
    ...
    def batch(
        ...
        *,
        ...
        logger.info(
            "Batch invoking PromptGenerator with {} prompt inputs.",
            len(batch_inputs),
        )
